module.exports = app => {
  ...
  // Retrieve project job opportunities
  ...
  // Update project infos (from project dashboard page)
  app.put("/project/:projectUsername/updateProjectInfos", checkToken, projects.updateProjectInfos);
  ...
  app.delete("/project/:projectId/removeParticipationRequest", checkToken, projects.removeParticipationRequest);
