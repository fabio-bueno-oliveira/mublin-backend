...
Feed.newPost = (loggedID, id_item_fk, related_item_type, id_feed_type_fk, extra_text, image, video_url, result) => {
  let x = jwt.verify(loggedID.slice(7), process.env.JWT_SECRET)
