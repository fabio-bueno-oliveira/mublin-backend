...
Project.findAllByUser = (userId, result) => {
  ...
  LEFT JOIN (SELECT id, response, id_event_fk FROM events_invitations) AS events_invitations ON events.id = events_invitations.id_event_fk 
